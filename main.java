...
public class main {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
      ...
      paciente Paciente1 = new paciente(paciente1[0],paciente1[1],paciente1[2].charAt(0));
      paciente Paciente2 = new paciente(paciente2[0],paciente2[1],paciente2[2].charAt(0));
      paciente Paciente3 = new paciente(paciente3[0],paciente3[1],paciente3[2].charAt(0));
      paciente Paciente4 = new paciente(paciente4[0],paciente4[1],paciente4[2].charAt(0));
